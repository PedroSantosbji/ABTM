  ...
  },
  {
    ...
    tabs:[
      { label:"Cliente", color:"#92400e", sections:[
        ...
        {title:"Inteligência", items:["Sugestão de pedido (IA)","Resumo inteligente de atendimento (IA)"]},
...
const RM_GROUPS = [
  {
    ...
    features:[
      ...
      { name:"Dashboard executivo Admin",             s:1, e:3, type:"config"  },
      { name:"S. Treinamento: Dashboard + KPIs",          s:3, e:4, type:"feature" },
      { name:"S. Treinamento: Atendimentos e alocação",   s:3, e:4, type:"feature" },
      { name:"S. Treinamento: Treinamento de promotores", s:4, e:4, type:"feature" },
      { name:"S. Merchandising: Gôndola e execução",  s:4, e:5, type:"feature" },
      { name:"S. Operacional: Central de desvios",    s:4, e:5, type:"feature" },
      { name:"Alertas Inteligentes",                  s:4, e:4, type:"feature" },
    ],
  },
  {
    ...
    features:[
      ...
      { name:"Onboarding guiado (1ª vez no app)",    s:1, e:5, type:"feature" },
      { name:"Base de vídeos tutoriais",             s:2, e:3, type:"feature" },
      { name:"Dashboard + Calendário de trabalho",   s:1, e:3, type:"feature" },
      { name:"Offline-first + Sync automático",      s:2, e:4, type:"feature" },
      { name:"Check-in + Geofence + Ponto",          s:3, e:3, type:"feature" },
      { name:"Diagnóstico do PDV + Fotos",           s:2, e:3, type:"feature" },
      { name:"Reposição por corredor",               s:3, e:4, type:"feature" },
      { name:"Controle de vencimentos",              s:3, e:3, type:"feature" },
      { name:"Live Map em tempo real",               s:3, e:5, type:"feature" },
    ],
  },
  {
    ...
    features:[
      ...
      { name:"Dashboard operacional do dia",          s:4, e:5, type:"feature" },
      { name:"Book fotográfico antes/depois",         s:4, e:5, type:"feature" },
      { name:"Tickets e solicitações",               s:5, e:5, type:"feature" },
      { name:"Alertas proativos de ruptura",          s:5, e:5, type:"feature" },
    ],
  },
  {
        ...
        <div className="card">
          ...
          {[
            ...
            { init:"PC", bg:"#fef9c3", tc:"#92400e", name:"Portal do Cliente", sub:"Web · Indústria",
              items:["Visão operacional do dia","Book fotográfico antes/depois","Alertas proativos de ruptura","Tickets e solicitações","Sugestão de pedido (IA)","Resumo inteligente de atendimento (IA)"] },
